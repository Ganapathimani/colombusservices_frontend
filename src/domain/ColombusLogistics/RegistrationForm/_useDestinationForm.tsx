...
import {
  faUser, faEnvelope, faPhone, faMapMarkerAlt, faCity, faTrashAlt, faAdd, faContactBook,
    ...
    <Stack spacing={3}>
      {fields.map((field, index) => (
        ...
        >
          <TextField
            label="Company Name"
            {...register(`deliveries.${index}.companyName` as const, {
          ...
          <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
            <TextField
              ...
              {...register(`deliveries.${index}.contactPerson` as const)}
              InputProps={{
                startAdornment: (
                  <InputAdornment position="start">
          ...
          <TextField
            label="Address"
            {...register(`deliveries.${index}.address` as const, {
          ...
          <TextField
            label="Location"
            {...register(`deliveries.${index}.location` as const, {
